                                      ...
                                      <td role="modules-container"
                                                            ...
                                                            <tr>
                                                              <td
                                                                ...
                                                                <img class="max-width" border="0"
                                                                  ...
                                                                  width="29" alt="" data-proportionally-constrained="true"
                                                              ...
                                                              <td
                                                                ...
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="font-size: 43px">Thanks for signing up,
                                                                      ${name}!&nbsp;</span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td
                                                                ...
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="font-size: 18px">Please verify your email
                                                                      address to</span><span
                                                                      style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif">
                                                                      get access to thousands of exclusive job
                                                                      listings</span><span
                                                                    ...
                                                                    <tr>
                                                                      <td align="center" bgcolor="#ffbe00"
                                                                        ...
                                                                        <a href="${verificationLink}"
                                                                          ...
                                                                          target="_blank">Verify Email Now for account activation</a>
                                                                      </td>
                                                                    </tr>
                                                                  </tbody>
                                                                </table>
                                                                  ...
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span
                                                                      style="color: #ffffff; font-size: 18px"><strong>Here’s
                                                                        what happens next:</strong></span></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <br></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="color: #ffffff; font-size: 18px">1.
                                                                      Upload your resume &nbsp;and we'll keep it on file
                                                                      for every job submission.</span></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <br></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="color: #ffffff; font-size: 18px">2.
                                                                      Submit and edit personalized cover letters for every
                                                                      job you apply to.</span></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <br></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="color: #ffffff; font-size: 18px">3. Get
                                                                      access to our career coaches when you need 1:1 help
                                                                      with your job application.</span></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span
                                                                      style="color: #ffbe00; font-size: 18px"><strong>+
                                                                        much more!</strong></span></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <br></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="color: #ffffff; font-size: 18px">Need
                                                                      support? Our support team is always</span></div>
                                                                  <div style="font-family: inherit; text-align: center">
                                                                    <span style="color: #ffffff; font-size: 18px">ready to
                                                                      help!&nbsp;</span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                        ...
                                        <div data-role="module-unsubscribe" class="module" role="module"
                                          ...
                                          <p style="font-size:12px; line-height:20px;"><a
                                              class="Unsubscribe--unsubscribeLink" href="{{{unsubscribe}}}"
                                              target="_blank" style="">Unsubscribe</a> - <a
                                              href="{{{unsubscribe_preferences}}}" target="_blank"
                                              class="Unsubscribe--unsubscribePreferences" style="">Unsubscribe
                                              Preferences</a></p>
                                        </div>
                                        <table border="0" cellpadding="0" cellspacing="0" class="module"
                                          data-role="module-button" data-type="button" role="module"
                                                    ...
                                                    <tr>
                                                      <td align="center" bgcolor="#f5f8fd" class="inner-td"
                                                        ...
                                                        <a href="https://sendgrid.com/"
                                                          ...
                                                          target="_blank">♥ POWERED BY TWILIO SENDGRID</a></td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              </td>
